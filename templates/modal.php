...
<div id="psl-modal" class="psl-modal" aria-hidden="true">
  ...
  <div class="psl-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="psl-modal-title">
    <button class="psl-modal__close" type="button" data-psl-close aria-label="<?php echo esc_attr__('Close modal', 'psl'); ?>">
      <!-- X icon -->
      <svg width="14" height="14" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M18.3 5.7a1 1 0 0 0-1.4-1.4L12 9.17 7.1 4.3A1 1 0 0 0 5.7 5.7L10.6 10.6 5.7 15.5a1 1 0 1 0 1.4 1.4L12 12.03l4.9 4.87a1 1 0 0 0 1.4-1.4L13.4 10.6l4.9-4.9Z" fill="currentColor"/>
      </svg>
    </button>
    ...
    <div class="psl-modal__actions">
      ...
      <?php if (!empty($install)) : ?>
        <a class="psl-btn" target="_blank" rel="noopener" href="<?php echo esc_url($install); ?>">
          ...
          <?php echo esc_html__('How to install Pexelle?', 'psl'); ?>
        </a>
      <?php endif; ?>
      ...
      <?php if (!empty($how)) : ?>
        <a class="psl-btn psl-btn--ghost" target="_blank" rel="noopener" href="<?php echo esc_url($how); ?>">
          ...
          <?php echo esc_html__('How Pexelle works?', 'psl'); ?>
        </a>
      <?php endif; ?>
    </div>
  </div>
