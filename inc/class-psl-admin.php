...
final class Psl_Admin {
    ...
    public static function sanitize_settings($input) {
        ...
        $out['button_text'] = isset($input['button_text']) ? sanitize_text_field($input['button_text']) : 'Add to Pexelle Record';
...
<div class="wrap">
    <div style="margin-bottom:20px;">
        <img src="<?php echo esc_url($logo_url); ?>" alt="<?php esc_attr_e('Pexelle Logo', 'pexelle-for-learndash'); ?>"
...
<?php
    ...
    public static function field_enabled() {
        ...
        ?>
<label>
    <input type="checkbox" name="<?php echo esc_attr(Psl_Plugin::OPTION_KEY); ?>[enabled]" value="1"
        <?php checked(1, isset($opts['enabled']) ? $opts['enabled'] : 0); ?> />
    <?php esc_html_e('Enable "Add to Pexelle Record" button & modal', 'pexelle-for-learndash'); ?>
</label>
<?php
    }
    ...
    public static function field_button_text() {
        $opts = get_option(Psl_Plugin::OPTION_KEY, []);
        ?>
<input type="text" class="regular-text" name="<?php echo esc_attr(Psl_Plugin::OPTION_KEY); ?>[button_text]"
    value="<?php echo esc_attr($opts['button_text'] ?? 'Add to Pexelle Record'); ?>" />
<?php
    }
    ...
    public static function field_help_install() {
        $opts = get_option(Psl_Plugin::OPTION_KEY, []);
        ?>
<input type="url" class="regular-text" name="<?php echo esc_attr(Psl_Plugin::OPTION_KEY); ?>[help_install_url]"
    value="<?php echo esc_attr($opts['help_install_url'] ?? ''); ?>" />
<?php
    }
    ...
    public static function field_help_how() {
        $opts = get_option(Psl_Plugin::OPTION_KEY, []);
        ?>
<input type="url" class="regular-text" name="<?php echo esc_attr(Psl_Plugin::OPTION_KEY); ?>[help_how_url]"
    value="<?php echo esc_attr($opts['help_how_url'] ?? ''); ?>" />
<?php
    }
}
